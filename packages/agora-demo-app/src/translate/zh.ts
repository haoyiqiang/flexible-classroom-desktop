...
export default {
  ...
  home_form_field_room_id: '房间ID',
  home_form_field_room: '房间名',
  home_form_field_chat: '聊天分组',
  home_form_field_name: '用户名',
  home_form_field_user_id: '用户ID',
  home_form_field_role: '角色',
  home_form_field_type: '房间类型',
  home_form_field_duration: '时长',
  home_form_submit: '进入房间',
  home_form_placeholder_room_id: '请输入房间ID',
  home_form_placeholder_user_id: '请输入用户ID',
  home_form_placeholder_room_name: '请输入房间名称',
  home_form_placeholder_chat_group: '请输入聊天分组，逗号分隔，例如1111-2332，1111-2333',
  ...
  home_form_error_room_id_limit: '房间ID为{min}位字符',
  home_form_error_user_id_limit:  '用户ID为{min}位字符',
  home_form_error_chat_group_illegal: '聊天分组{text}格式不正确',
